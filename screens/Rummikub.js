...
const Rummikub = ({navigation}) =>{
    ...
    return (
        ...
        <Text style={styles.title}>Rummikub</Text>
      <Image style={styles.img} source={require('../assets/images/rummikub.jpg')}/>
      <View style={styles.details}>
        </View>
      </View>
      <View>
        <Text style={styles.what}>Beschrijving</Text>
        <Text style={styles.description}>Wie legt de slimste combinaties? Rummikub is een spel dat inzicht, durf en tactiek combineert. In een handig tinnen opbergblik zodat je het ook op reis kan spelen.</Text>
      </View>
      <View>
