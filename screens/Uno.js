...
const Uno = ({navigation}) =>{
    ...
    return (
      ...
      <Image style={styles.img} source={require('../assets/images/uno.jpg')}/>
      <View style={styles.details}>
        </View>
      </View>
      <View>
        <Text style={styles.what}>Beschrijving</Text>
        <Text style={styles.description}>Raak als eerste al je kaarten kwijt door kleuren of nummers te laten passen. Vergeet vooral niet Uno te roepen als je nog slechts 1 kaartje in handen hebt!</Text>
      </View>
      <View>
        <Text style={styles.price}>€10.95</Text>
      </View>
